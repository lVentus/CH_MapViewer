...
IterativeDFSUnfoldingStrategy::IterativeDFSUnfoldingStrategy(
    const std::filesystem::path& shaderDirectory)
    : prepareDispatchProgram_(shaderDirectory / "unfold_prepare_dispatch.comp"),
      unfoldProgram_(shaderDirectory / "unfold_iterative_dfs.comp"),
...
UnfoldingOutput IterativeDFSUnfoldingStrategy::Execute(const UnfoldingInput& input) {
...
void IterativeDFSUnfoldingStrategy::EnsureCapacity(std::uint32_t capacity) {
