...
function(do_fetch)
  ...
  execute_process(
    ...
    WORKING_DIRECTORY "/home/ventus/Project/CH_MapViewer/build-linux/_deps/glfw-src"
...
execute_process(
  COMMAND "/nix/store/msr1v91ybfw6j12rs5mfl8ghb2rqsnsr-git-2.55.0/bin/git" --git-dir=.git show-ref "3.4"
  WORKING_DIRECTORY "/home/ventus/Project/CH_MapViewer/build-linux/_deps/glfw-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/ventus/Project/CH_MapViewer/build-linux/_deps/glfw-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/ventus/Project/CH_MapViewer/build-linux/_deps/glfw-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
